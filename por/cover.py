...
asker reads to drop covers before routing (``por.expert_route`` skips them). The
...
from .handles import OPAQUE_HANDLE_SIZE, OpaqueHandle
from .memory_index import COVER_MARKER, MemoryManifest
